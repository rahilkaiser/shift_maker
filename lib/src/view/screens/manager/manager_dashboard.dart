  ...
  Widget build(BuildContext context) {
    ...
    return MultiBlocProvider(
      providers: [
        ...
        BlocProvider(
          create: (context) => SelectedWorkerBloc(),
        ),
      ],
      child: BlocBuilder<SelectedWorkerBloc, SelectedWorkerState>(
        builder: (context, selectWorkerState) {
          return BlocBuilder<SelectedDepartmentBloc, SelectedDepartmentState>(
                              ...
                              if (isEditableState.isEditable && selectWorkerState.workerEntity != null && tabsRouter.activeIndex == 1) {
                                return IconButton(
                                  onPressed: () {
                                    ...
                                    AutoRouter.of(context)
                                        .push(
                                          ManagerWorkerEditorRoute(
                                            worker: selectWorkerState.workerEntity!,
                                          ),
                                        )
                                        .then(
